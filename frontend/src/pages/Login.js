...
//   return (
//     <div className="min-vh-100 d-flex align-items-center" style={{ background: "#fff8f5" }}>
//       <div className="container">
//         <div className="row justify-content-center">
//           <div className="col-md-5">
//             <div className="card border-0 shadow-lg p-4" style={{ borderRadius: "16px" }}>
//               <div className="text-center mb-4">
//                 <GiChiliPepper size={40} color="#b5451b" />
//                 <h3 className="fw-bold mt-2">Welcome Back!</h3>
//                 <p className="text-muted">Login to your MasalaHub account</p>
//               </div>
...
//                 New user?{" "}
//                 <Link to="/register" style={{ color: "#b5451b" }}>
//                   Create Account
//                 </Link>
//               </p>
//             </div>
