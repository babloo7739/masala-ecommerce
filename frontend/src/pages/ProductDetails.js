...
//   if (loading) return <div className="text-center py-5"><div className="spinner-border" style={{ color: "#b5451b" }}></div></div>;
...
//             onError={(e) => (e.target.src = "https://via.placeholder.com/400?text=Spice")}
//           />
//         </div>

//         {/* Product Info */}
//         <div className="col-md-7">
//           <span className="badge mb-2" style={{ background: "#f4a261" }}>{product.category}</span>
//           <h2 className="fw-bold">{product.name}</h2>
//           {product.origin && <p className="text-muted">📍 Origin: {product.origin}</p>}

//           <div className="d-flex align-items-center gap-2 mb-3">
//             {[1,2,3,4,5].map((s) => (
//               <FaStar key={s} color={s <= Math.round(product.rating) ? "#f4a261" : "#ccc"} />
//             ))}
//             <span className="text-muted">({product.numReviews} reviews)</span>
//           </div>

//           <h3 className="fw-bold mb-1" style={{ color: "#b5451b" }}>₹{product.price}</h3>
...
//               <div key={r._id} className="card border-0 bg-light mb-3 p-3">
