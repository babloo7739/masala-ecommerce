...
// const Cart = () => {
//   const { cartItems, itemsPrice, shippingPrice, totalPrice } = useCart();
...
//         <FaShoppingCart className="me-2" style={{ color: "#b5451b" }} />
...
//           <Link to="/" className="btn mt-3" style={{ background: "#b5451b", color: "white" }}>
//             Shop Now
//           </Link>
//         </div>
//       ) : (
...
//               </div>
//               {shippingPrice > 0 && (
//                 <small className="text-muted mb-2">Add ₹{(500 - itemsPrice).toFixed(0)} more for free shipping</small>
//               )}
//               <hr />
//               <div className="d-flex justify-content-between fw-bold fs-5 mb-3">
//                 <span>Total</span>
//                 <span style={{ color: "#b5451b" }}>₹{totalPrice.toFixed(2)}</span>
//               </div>
//               <button
